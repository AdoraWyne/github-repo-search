...
describe("relativeTimeFn", () => {
  ...
  const TEST_CASES = [
    ...
    // diff: 30s
    {
      ...
      output: "Updated less than 1 minute ago",
    },
    // exact 1 min
    {
      dateNow: DATE_NOW,
      updatedAtTime: "2026-05-05T09:59:00Z",
      output: "Updated 1 minute ago",
    },
